...
📝 Create & Manage Resumes Create multiple resumes Edit, update, and delete resumes easily

👀 Live Resume Preview Real-time preview while editing Generate a shareable resume link

🌐 Share Resume Share your resume via a live URL

🤖 AI Resume Optimization Improve resume content using Google Gemini AI

📄 Upload Resume Upload existing resume and enhance it using AI

🖼️ Profile Image Handling Upload profile images Remove background from images
